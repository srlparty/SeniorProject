...
if (isset($_POST["id"])) {
    $id = $_POST["id"];
    $data = "SELECT * FROM roombook,payment,room_categories,bank WHERE roombook.room_cat_id=room_categories.id and payment.B_id=roombook.b_id and payment.PM_Bank=bank.Bank_ID and roombook.b_id = '$id'";
    $output = '';
