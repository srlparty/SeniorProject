<!-- Modal -->
<div class="modal fade" id="detail-booking" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <label for="text" class="form-label"><b>ประเภทห้อง</b></label><br>
                            <label for="text" class="form-label"><b>เตียง</b></label><br>
                            <div class="QTY-room"><b>จำนวนห้อง :</b>
                                <label for="text" class="form-label"></label><br>
                            </div>                            
                            <div class="QTY-people"><b>จำนวนคน :</b>
                                <label for="text" class="form-label" ></label><br>
                            </div>
                            ...
                            <div class="price-book"><b>ราคารวม :</b>
                                <label for="text" class="form-label" id="PM_Total">ใส่โค้ด</label><br>
                            </div>
                        </div>
                        <div class="col-md-5 ms-auto">หลักฐานการชำระเงิน
                            <div class="img-pay">
                                <img src="" alt="">
                            </div>
                        </div>
